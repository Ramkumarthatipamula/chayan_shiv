<template>
  <f7-page>
    ...
    <f7-block-title class="searchbar-found">Menu</f7-block-title>
    <f7-list class="components-list searchbar-found">
      ...
      <f7-list-item link="/research/" title="Research" panel-close>
        <f7-icon slot="media" ios="f7:info" md="material:info"></f7-icon>
      </f7-list-item>
      <f7-list-item link="/images/" title="Images" panel-close>
        <f7-icon slot="media" icon="fas fa-id-card-alt fa-fw"></f7-icon>
      </f7-list-item>
      <f7-list-item link="/videos/" title="Videos" panel-close>
        <f7-icon slot="media" ios="f7:info" md="material:info"></f7-icon>
      </f7-list-item>
      <f7-list-item link="/ebooks/" title="E-Books" panel-close>
        <f7-icon slot="media" ios="f7:info" md="material:info"></f7-icon>
      </f7-list-item>
      <f7-list-item link="/contactus/" title="Contact Us" panel-close>
        <f7-icon slot="media" icon="fas fa-id-card-alt fa-fw"></f7-icon>
      </f7-list-item>
